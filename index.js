...
var CachingWriter = CoreObject.extend({
  enforceSingleInputTree: false,
...
// one include pattern.
  shouldBeIgnored: function (fullPath) {
  ...
  keyForTree: function (fullPath, initialRelativePath) {
